"""
fi-code Web 端 E2E 测试共享 fixtures
"""
import os
import sys
import asyncio
...
from utils.mock_ai import MockAIServer
from utils.project import TestProjectManager
from utils.vite_server import ViteDevServer
...
async def fi_code_server() -> AsyncGenerator[FiCodeServerManager, None]:
    """
    fi-code 服务器 fixture (session 级别)
...
async def mock_ai_server() -> AsyncGenerator[MockAIServer, None]:
    """
    Mock AI 服务器 fixture (session 级别)
...
async def browser() -> AsyncGenerator[Browser, None]:
    """
    Playwright 浏览器 fixture (session 级别)
